...
import { BlockStack, InlineStack, Pagination, Text, LegacyCard, EmptyState } from "@shopify/polaris";
...
const SurveyBarChart = ({ surveyData, language }) => {
    ...
    //If need to hide french or english
    // const count = filteredSurveyData[0].questions.reduce((acc, question) => {
    //   return acc + (question.answersCount ? question.answersCount.length : 0);
    // }, 0);
